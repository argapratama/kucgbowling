...
public:
    ...
    static bool	IsPointOnFace(Vector3 pt, Vector3 f[4])
    {
        ...
        if((Math::FAbs(n.X()) > Math::FAbs(n.X())) && (Math::FAbs(n.X()) > Math::FAbs(n.Z())))
	    {
            // flatten in yz plane
		    for(int i = 0; i < 4; i++)
		    {
        ...
        else if((Math::FAbs(n.Y()) > Math::FAbs(n.X())) && (Math::FAbs(n.Y()) > Math::FAbs(n.Z())))
	    {
            // flatten in xz plane
		    for(i=0; i<4; i++)
		    {
        ...
        else if((Math::FAbs(n.Z()) > Math::FAbs(n.X())) && (Math::FAbs(n.Z()) > Math::FAbs(n.Y())))
	    { 
            // flatten in xy plane
		    for(int i = 0; i < 4; i++)
		    {
