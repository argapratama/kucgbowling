...
//double Cpos[3] = {10.0, 1.0, 2.0};	// Position of camera
...
//float par0verts[3][3] = { {-50.0f,0.0f,3.0f}, {50.0f,0.0f,3.0f}, {50.0f,0.0f,-3.0f} };
