...
**
** 11/30/2001 Revised by Hans Weber (magic@the-webers.org) to provide
...
#if WGL_WGLEXT_VERSION < 1
#error "glprocs.{h,c} requires at least wglext.h v. 1.  Please download it from http://oss.sgi.com/projects/ogl-sample/ABI/"
#elif WGL_WGLEXT_VERSION > 1
#error "glprocs.{h,c} will not support new features in wglext.h v. > 1 (comment out this #error to ignore this warning)"
#endif
...
//#error "glprocs.{h,c} requires at least glext.h v. 9. Please download it from http://oss.sgi.com/projects/ogl-sample/ABI/"
//#elif GL_GLEXT_VERSION > 9
//#error "glprocs.{h,c} will not support new features in glext.h v. > 9 (comment out this #error to ignore this warning)"
//#endif
...
typedef struct {
  ...
  void (APIENTRY *VertexAttribPointerARB) (GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void *pointer);
...
#define glDeleteObjectBufferATI          (_GET_TLS_PROCTABLE()->DeleteObjectBufferATI)
...
#define glVertexStream1s                 (_GET_TLS_PROCTABLE()->VertexStream1s)
#define glVertexStream1sv                (_GET_TLS_PROCTABLE()->VertexStream1sv)
#define glVertexStream1i                 (_GET_TLS_PROCTABLE()->VertexStream1i)
#define glVertexStream1iv                (_GET_TLS_PROCTABLE()->VertexStream1iv)
#define glVertexStream1f                 (_GET_TLS_PROCTABLE()->VertexStream1f)
#define glVertexStream1fv                (_GET_TLS_PROCTABLE()->VertexStream1fv)
#define glVertexStream1d                 (_GET_TLS_PROCTABLE()->VertexStream1d)
#define glVertexStream1dv                (_GET_TLS_PROCTABLE()->VertexStream1dv)
#define glVertexStream2s                 (_GET_TLS_PROCTABLE()->VertexStream2s)
#define glVertexStream2sv                (_GET_TLS_PROCTABLE()->VertexStream2sv)
#define glVertexStream2i                 (_GET_TLS_PROCTABLE()->VertexStream2i)
#define glVertexStream2iv                (_GET_TLS_PROCTABLE()->VertexStream2iv)
#define glVertexStream2f                 (_GET_TLS_PROCTABLE()->VertexStream2f)
#define glVertexStream2fv                (_GET_TLS_PROCTABLE()->VertexStream2fv)
#define glVertexStream2d                 (_GET_TLS_PROCTABLE()->VertexStream2d)
#define glVertexStream2dv                (_GET_TLS_PROCTABLE()->VertexStream2dv)
#define glVertexStream3s                 (_GET_TLS_PROCTABLE()->VertexStream3s)
#define glVertexStream3sv                (_GET_TLS_PROCTABLE()->VertexStream3sv)
#define glVertexStream3i                 (_GET_TLS_PROCTABLE()->VertexStream3i)
#define glVertexStream3iv                (_GET_TLS_PROCTABLE()->VertexStream3iv)
#define glVertexStream3f                 (_GET_TLS_PROCTABLE()->VertexStream3f)
#define glVertexStream3fv                (_GET_TLS_PROCTABLE()->VertexStream3fv)
#define glVertexStream3d                 (_GET_TLS_PROCTABLE()->VertexStream3d)
#define glVertexStream3dv                (_GET_TLS_PROCTABLE()->VertexStream3dv)
#define glVertexStream4s                 (_GET_TLS_PROCTABLE()->VertexStream4s)
#define glVertexStream4sv                (_GET_TLS_PROCTABLE()->VertexStream4sv)
#define glVertexStream4i                 (_GET_TLS_PROCTABLE()->VertexStream4i)
#define glVertexStream4iv                (_GET_TLS_PROCTABLE()->VertexStream4iv)
#define glVertexStream4f                 (_GET_TLS_PROCTABLE()->VertexStream4f)
#define glVertexStream4fv                (_GET_TLS_PROCTABLE()->VertexStream4fv)
#define glVertexStream4d                 (_GET_TLS_PROCTABLE()->VertexStream4d)
#define glVertexStream4dv                (_GET_TLS_PROCTABLE()->VertexStream4dv)
#define glNormalStream3b                 (_GET_TLS_PROCTABLE()->NormalStream3b)
#define glNormalStream3bv                (_GET_TLS_PROCTABLE()->NormalStream3bv)
#define glNormalStream3s                 (_GET_TLS_PROCTABLE()->NormalStream3s)
#define glNormalStream3sv                (_GET_TLS_PROCTABLE()->NormalStream3sv)
#define glNormalStream3i                 (_GET_TLS_PROCTABLE()->NormalStream3i)
#define glNormalStream3iv                (_GET_TLS_PROCTABLE()->NormalStream3iv)
#define glNormalStream3f                 (_GET_TLS_PROCTABLE()->NormalStream3f)
#define glNormalStream3fv                (_GET_TLS_PROCTABLE()->NormalStream3fv)
#define glNormalStream3d                 (_GET_TLS_PROCTABLE()->NormalStream3d)
#define glNormalStream3dv                (_GET_TLS_PROCTABLE()->NormalStream3dv)
#define glClientActiveVertexStream       (_GET_TLS_PROCTABLE()->ClientActiveVertexStream)
#define glVertexBlendEnvi                (_GET_TLS_PROCTABLE()->VertexBlendEnvi)
#define glVertexBlendEnvf                (_GET_TLS_PROCTABLE()->VertexBlendEnvf)
